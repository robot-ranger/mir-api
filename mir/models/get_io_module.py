...
class GetIoModule(object):
    ...
    def __init__(self, guid=None, name=None, type=None, address=None, num_inputs=None, num_outputs=None, created_by_id=None, created_by=None, _configuration=None):  # noqa: E501
